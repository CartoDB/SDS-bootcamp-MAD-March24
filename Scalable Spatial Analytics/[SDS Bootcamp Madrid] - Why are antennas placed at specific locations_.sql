  ...
  */
  ...
  BEGIN
    ...
    IF proceduretablesCount < 1 THEN
      BEGIN
        BEGIN
        CREATE VIEW IF NOT EXISTS `carto-dw-ac-7xhfwyml.workflows_temp_lgarciaduarte_0a0e7b7c.WORKFLOW_ecb0eafb920efd67_72aeb9ebcfdfe175_out`
        OPTIONS (
        ...
        CREATE TABLE `carto-dw-ac-7xhfwyml.workflows_temp_lgarciaduarte_0a0e7b7c.table_e3153872_2046_4274_a9d6_ae370d56f753` AS
        ...
        '''
          ...
          WHERE table_name = 'table_e3153872_2046_4274_a9d6_ae370d56f753'
          )
          SELECT STRING_AGG(col_alias, ', ')
          FROM __alias
        '''
        INTO alias;
        DROP TABLE `carto-dw-ac-7xhfwyml.workflows_temp_lgarciaduarte_0a0e7b7c.table_e3153872_2046_4274_a9d6_ae370d56f753`;
        EXECUTE IMMEDIATE
        REPLACE(
          '''CREATE TEMPORARY TABLE IF NOT EXISTS `WORKFLOW_ecb0eafb920efd67_b014d6ade2dca9cc_result`
          AS
            SELECT
              _main.*,
              %s
        ...
        BEGIN
          ...
          DECLARE tableNames ARRAY<STRING> DEFAULT ['\'WORKFLOW_ecb0eafb920efd67_84a5d70ec963c001_result\''];
          EXECUTE IMMEDIATE '''
            SELECT COUNT(1) AS cnt
            FROM `carto-dw-ac-7xhfwyml.workflows_temp_lgarciaduarte_0a0e7b7c.__TABLES_SUMMARY__`
          ...
          IF tablesCount < 1 THEN
            BEGIN
              ...
              CALL `carto-un.carto`.__CHECK_GRID_INDEX_COLUMN(
                'SELECT * FROM `WORKFLOW_ecb0eafb920efd67_b014d6ade2dca9cc_result`',
                'h3',
                grid_type,
                grid_resolution
              );
              IF grid_type = 'quadbin' THEN
                CALL `carto-un.carto`.LOCAL_MORANS_I_QUADBIN_TABLE(
                  'WORKFLOW_ecb0eafb920efd67_b014d6ade2dca9cc_result',
                  '`carto-dw-ac-7xhfwyml.workflows_temp_lgarciaduarte_0a0e7b7c.__temp_d9583087_1dac_4a87_8472_3fb828492ec2`',
                  'h3',
                  'cell_counts_joined',
                  4,
                  'uniform',
              ...
              END IF;
              CREATE TEMPORARY TABLE IF NOT EXISTS `WORKFLOW_ecb0eafb920efd67_84a5d70ec963c001_result`
              AS
                SELECT * FROM `carto-dw-ac-7xhfwyml.workflows_temp_lgarciaduarte_0a0e7b7c.__temp_d9583087_1dac_4a87_8472_3fb828492ec2`;
            END;
          END IF;
        END;
        END;
        CREATE TEMPORARY TABLE IF NOT EXISTS `WORKFLOW_ecb0eafb920efd67_654e63c641643ce7_result`
        AS
          WITH
          cte_1 AS (
            SELECT *,
              REPLACE(REPLACE(REPLACE(REPLACE(CAST(quad as string), '1', 'HH'), '2', 'LL'), '3', 'LH'), '4', 'HL') AS clust
            FROM `WORKFLOW_ecb0eafb920efd67_84a5d70ec963c001_result`
          )
          SELECT * FROM cte_1;
        BEGIN
        DECLARE alias STRING;
        CREATE TABLE `carto-dw-ac-7xhfwyml.workflows_temp_lgarciaduarte_0a0e7b7c.table_c46e0b65_2e02_417b_9ad8_69ec95550e3f` AS
        SELECT * FROM `WORKFLOW_ecb0eafb920efd67_654e63c641643ce7_result`
        WHERE 1=0;
        EXECUTE IMMEDIATE
        '''
          with __alias AS(
            ...
            FROM `carto-dw-ac-7xhfwyml.workflows_temp_lgarciaduarte_0a0e7b7c`.INFORMATION_SCHEMA.COLUMNS
          WHERE table_name = 'table_c46e0b65_2e02_417b_9ad8_69ec95550e3f'
          )
          SELECT STRING_AGG(col_alias, ', ')
          FROM __alias
        '''
        INTO alias;
        DROP TABLE `carto-dw-ac-7xhfwyml.workflows_temp_lgarciaduarte_0a0e7b7c.table_c46e0b65_2e02_417b_9ad8_69ec95550e3f`;
        EXECUTE IMMEDIATE
        REPLACE(
          '''CREATE TEMPORARY TABLE IF NOT EXISTS `WORKFLOW_ecb0eafb920efd67_d1fda0d76c8ebc2a_result`
          AS
            SELECT
              _main.*,
              %s
            FROM
              `WORKFLOW_ecb0eafb920efd67_b014d6ade2dca9cc_result` AS _main
              INNER JOIN
              `WORKFLOW_ecb0eafb920efd67_654e63c641643ce7_result` AS _joined
            ON
        ...
        END;
        CREATE TEMPORARY TABLE IF NOT EXISTS `WORKFLOW_ecb0eafb920efd67_1cda0450741971a0_result`
        AS
          WITH
          cte_1 AS (
            SELECT clust_joined,
            ...
            FROM `WORKFLOW_ecb0eafb920efd67_d1fda0d76c8ebc2a_result`
        ...
        BEGIN
          DECLARE tablesCount INT64;
          DECLARE tableNames ARRAY<STRING> DEFAULT ['\'WORKFLOW_ecb0eafb920efd67_1d2d1efd2f53e213_result\''];
          EXECUTE IMMEDIATE '''
            SELECT COUNT(1) AS cnt
            FROM `carto-dw-ac-7xhfwyml.workflows_temp_lgarciaduarte_0a0e7b7c.__TABLES_SUMMARY__`
            WHERE table_id IN (''' || ARRAY_TO_STRING(tableNames, ', ') || ''')
            ...
            BEGIN
              ...
              IF grid_type != 'unsupported' THEN
                CALL `carto-un.carto`.GWR_GRID(
                  ...
                  'gaussian',
                  true,
                  'WORKFLOW_ecb0eafb920efd67_1d2d1efd2f53e213_result'
                );
              ELSE
                  RAISE USING MESSAGE = 'Invalid spatial index column, please select a column that contains h3 or quadbin indexes.';
              END IF;
        ...
        END;
        END;
        CREATE TEMPORARY TABLE IF NOT EXISTS `WORKFLOW_ecb0eafb920efd67_3e423b08ea6ad7ef_result`
        AS
          WITH
          cte_1 AS (
            SELECT
                MAX(cell_counts_joined) cell_counts_joined_max
            FROM `WORKFLOW_ecb0eafb920efd67_b014d6ade2dca9cc_result`
          )
          SELECT * FROM cte_1;
        BEGIN
        CREATE TEMPORARY TABLE IF NOT EXISTS `WORKFLOW_ecb0eafb920efd67_8db0e9b5b09699d8_result`
        AS
          SELECT h3, 
          cell_counts_joined_max - cell_counts_joined AS cell_counts_inv,  human_activity_index
          FROM `WORKFLOW_ecb0eafb920efd67_b014d6ade2dca9cc_result`, `WORKFLOW_ecb0eafb920efd67_3e423b08ea6ad7ef_result`;
        END;
        BEGIN
        DROP TABLE IF EXISTS `WORKFLOW_ecb0eafb920efd67_96220c617c5e10a2_result`;
        DROP TABLE IF EXISTS `WORKFLOW_ecb0eafb920efd67_96220c617c5e10a2_result_lookup_table`;
        CALL `carto-un.carto`.CREATE_SPATIAL_COMPOSITE_UNSUPERVISED(
          'SELECT h3, cell_counts_inv AS cell_counts_inv, human_activity_index AS human_activity_index FROM `WORKFLOW_ecb0eafb920efd67_8db0e9b5b09699d8_result`',
          'h3',
          'WORKFLOW_ecb0eafb920efd67_96220c617c5e10a2_result',
          '''
          {
        ...
        BEGIN
          DECLARE tablesCount INT64;
          DECLARE tableNames ARRAY<STRING> DEFAULT ['\'WORKFLOW_ecb0eafb920efd67_f690a3398cb4238a_result\''];
          EXECUTE IMMEDIATE '''
            SELECT COUNT(1) AS cnt
            FROM `carto-dw-ac-7xhfwyml.workflows_temp_lgarciaduarte_0a0e7b7c.__TABLES_SUMMARY__`
            WHERE table_id IN (''' || ARRAY_TO_STRING(tableNames, ', ') || ''')
          ...
          IF tablesCount < 1 THEN
            BEGIN
              ...
              DECLARE grid_resolution INT64;
              CALL `carto-un.carto`.__CHECK_GRID_INDEX_COLUMN(
                  'SELECT * FROM `WORKFLOW_ecb0eafb920efd67_96220c617c5e10a2_result`',
                  'h3',
                  grid_type,
                  grid_resolution
              );
              IF grid_type = 'quadbin' THEN
                  CALL `carto-un.carto`.GETIS_ORD_QUADBIN_TABLE(
                      'WORKFLOW_ecb0eafb920efd67_96220c617c5e10a2_result',
                      'carto-dw-ac-7xhfwyml.workflows_temp_lgarciaduarte_0a0e7b7c.__temp_509b6f13_2a0f_4145_bd08_1460ea68f89e',
                      'h3',
                      'spatial_score',
                      1,
                      'uniform'
              ...
              ELSE
                  RAISE USING MESSAGE = 'Invalid spatial index column, please select a column that contains h3 or quadbin indexes.';
              END IF;
              CREATE TEMPORARY TABLE IF NOT EXISTS `WORKFLOW_ecb0eafb920efd67_f690a3398cb4238a_result`
              AS
                SELECT * FROM `carto-dw-ac-7xhfwyml.workflows_temp_lgarciaduarte_0a0e7b7c.__temp_509b6f13_2a0f_4145_bd08_1460ea68f89e`;
            END;
          END IF;
        END;
        END;
        BEGIN
        CREATE TEMPORARY TABLE IF NOT EXISTS `WORKFLOW_ecb0eafb920efd67_a96a7ca61eb42397_result`
        ...
        AS
          ...
          FROM `WORKFLOW_ecb0eafb920efd67_f690a3398cb4238a_result`;
        END;
        BEGIN
        BEGIN
          DECLARE tablesCount INT64;
          DECLARE tableNames ARRAY<STRING> DEFAULT ['\'WORKFLOW_ecb0eafb920efd67_14df290457074abe_result\''];
          EXECUTE IMMEDIATE '''
            SELECT COUNT(1) AS cnt
            FROM `carto-dw-ac-7xhfwyml.workflows_temp_lgarciaduarte_0a0e7b7c.__TABLES_SUMMARY__`
            WHERE table_id IN (''' || ARRAY_TO_STRING(tableNames, ', ') || ''')
          ...
          IF tablesCount < 1 THEN
            BEGIN
              CALL `carto-un.carto`.ENRICH_POLYGONS(
                'carto-dw-ac-7xhfwyml.workflows_temp_lgarciaduarte_0a0e7b7c.WORKFLOW_ecb0eafb920efd67_72aeb9ebcfdfe175_out',
                'geom',
                'SELECT * FROM `WORKFLOW_ecb0eafb920efd67_a96a7ca61eb42397_result`',
                'index_geo',
                [('gi', 'avg'), ('p_value', 'max')],
                ['WORKFLOW_ecb0eafb920efd67_14df290457074abe_result']
              );
            END;
          END IF;
        END;
        END;
        BEGIN
        CREATE TEMPORARY TABLE IF NOT EXISTS `WORKFLOW_ecb0eafb920efd67_60c76d28894c326e_result`
        CLUSTER BY geom
        AS
          SELECT *,
            (
        ...
        END;
        BEGIN
        CREATE TEMPORARY TABLE IF NOT EXISTS `WORKFLOW_ecb0eafb920efd67_0d2155bf865dbb12_match`
        CLUSTER BY geom
        AS
          SELECT *
          FROM `WORKFLOW_ecb0eafb920efd67_60c76d28894c326e_result`
          WHERE gi_avg < 0;
        END;
        CREATE TEMPORARY TABLE IF NOT EXISTS `WORKFLOW_ecb0eafb920efd67_47c68260e0b613ba_result`
        AS
          WITH
          cte_1 AS (
            SELECT
                MAX(geom_area) geom_area_max
            FROM `WORKFLOW_ecb0eafb920efd67_0d2155bf865dbb12_match`
          )
          SELECT * FROM cte_1;
        BEGIN
        CREATE TEMPORARY TABLE IF NOT EXISTS `WORKFLOW_ecb0eafb920efd67_e479ab0d36c645a1_result`
        AS
          SELECT a.*, CASE WHEN gi_avg >= 0 THEN gi_avg * LOG(geom_area) ELSE gi_avg * LOG(geom_area_max/geom_area) END potential_score FROM `WORKFLOW_ecb0eafb920efd67_60c76d28894c326e_result` a , `WORKFLOW_ecb0eafb920efd67_47c68260e0b613ba_result`;
        END;
        BEGIN
        ...
        CALL `carto-un.carto`.CREATE_TILESET(
          '`WORKFLOW_ecb0eafb920efd67_e479ab0d36c645a1_result`',
